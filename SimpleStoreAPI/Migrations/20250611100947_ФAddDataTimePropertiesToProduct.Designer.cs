...
namespace SimpleStoreAPI.Migrations
{
    ...
    [Migration("20250611100947_ФAddDataTimePropertiesToProduct")]
    partial class ФAddDataTimePropertiesToProduct
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SimpleStoreAPI.Models.Orders.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SimpleStoreAPI.Models.Orders.OrderItem", b =>
                {
                    b.HasOne("SimpleStoreAPI.Models.Orders.Order", "Order")
                        .WithMany("OrderItems")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SimpleStoreAPI.Models.Product", "Product")
                        .WithMany()
